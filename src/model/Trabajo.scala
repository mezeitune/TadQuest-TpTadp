...
case object Ladron extends Trabajo(Velocidad,List(VariarStatEn(Inteligencia,20), VariarStatEn(Fuerza,-20)))
case object Mago extends Trabajo(Inteligencia,List(VariarStatEn(Velocidad,10), VariarStatEn(HP,-5)))
